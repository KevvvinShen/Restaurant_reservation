<?php
	...
	try
	{
		...
		//分頁
		//計算資料總共筆數
		$query_nums = mysqli_num_rows($query);
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2>餐廳訂位系統</h2>
					<ol class="breadcrumb">
						<li><a href="index.php">新增訂位資訊</a></li>
						<li><a href="admin_customer.php">會員</a></li>
					...
					<div class="panel panel-info">
						<div class="panel-heading">
							...
							<?php if( isset($_SESSION['admin']) && $_SESSION['admin'] == 'admin_yes' ): ?>
									...
									<a href="delete_message.php?id=<?php echo $val['id']; ?>&page=<?php echo $page; ?>"> <div class="text-right">修改</div> </a>
